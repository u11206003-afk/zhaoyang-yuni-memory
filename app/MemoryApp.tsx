  ...
  return <main className="app-shell">
    ...
    <section className="content">
      <header className="topbar">
        ...
        <div className="header-actions"><button className="invite" onClick={() => setInviteOpen(true)}>＋ 邀請她</button><button className="bell" aria-label="通知"><span className="bell-shape"/><i /></button><span className="profile">妳</span></div>
      </header>
